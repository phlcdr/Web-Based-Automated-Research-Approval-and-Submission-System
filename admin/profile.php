...
// Count pending user registrations for badge
...
<head>
    ...
    <title>Profile - Research Approval System</title>
    ...
    <style>
        ...
        * {
        ...
        .profile-avatar {
            ...
            height: 5rem;
            border-radius: 50%;
            background: linear-gradient(45deg, var(--university-blue), var(--university-gold));
            display: flex;
            align-items: center;
            justify-content: center;
            color: white;
...
<body>
                ...
                <div class="profile-info-card">
                    ...
                    <div class="section-body text-center">
                        ...
                        <div class="profile-stats">
                            ...
                            <div class="profile-stat">
                                <div class="profile-stat-value"><?php echo ucfirst($user['registration_status']); ?></div>
            ...
            <div class="section-body">
                <div class="row g-4">
                    ...
                    <div class="col-md-3">
                        ...
                        <span class="text-muted"><?php echo date('F j, Y g:i A', strtotime($user['created_at'])); ?></span>
                    </div>
                    <div class="col-md-3">
                        <strong>Registration Status:</strong><br>
                        <span class="academic-badge success"><?php echo ucfirst($user['registration_status']); ?></span>
                    </div>
                    <div class="col-md-3">
                        <strong>Role:</strong><br>
                        <span class="academic-badge primary"><?php echo ucfirst($user['role']); ?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        document.getElementById('new_password').addEventListener('input', function() {
            ...
            // Clear confirm password if new password changes
